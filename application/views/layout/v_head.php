...
<head>
    ...
    <title>Marketplace UMKM Kota Metro | <?php $title ?></title>
    ...
    <link rel="stylesheet" href="<?php base_url() ?>template/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    <link rel="stylesheet" href="<?php base_url() ?>template/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
    <!-- Theme style -->
    ...
    <script src="<?php base_url() ?>template/plugins/datatables-buttons/js/dataTables.buttons.min.js"></script>
    <script src="<?php base_url() ?>template/plugins/datatables-buttons/js/buttons.bootstrap4.min.js"></script>
    <script src="<?php base_url() ?>template/plugins/jszip/jszip.min.js"></script>
    <script src="<?php base_url() ?>template/plugins/pdfmake/pdfmake.min.js"></script>
    <script src="<?php base_url() ?>template/plugins/pdfmake/vfs_fonts.js"></script>
    <script src="<?php base_url() ?>template/plugins/datatables-buttons/js/buttons.html5.min.js"></script>
    <script src="<?php base_url() ?>template/plugins/datatables-buttons/js/buttons.print.min.js"></script>
    <script src="<?php base_url() ?>template/plugins/datatables-buttons/js/buttons.colVis.min.js"></script>
    <!-- AdminLTE App -->
