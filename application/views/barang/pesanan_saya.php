                    ...
                    <table class="table">
                        ...
                        foreach ($belum_bayar as $key => $value) { ?>
                           <tr>
                            ...
                            <td>
                            <?php if ($value->status_bayar == 0) { ?>
                              <a href="<?= base_url('pesanan_saya/bayar/'.$value->id_transaksi) ?>" class="btn btn-primary btn-sm">Bayar</a>
                                  <?php } ?> 
                            </td>
                        </tr>
                        <?php } ?>
                           ...
                           <tr>
                            ...
                            <td>
                                <b> <?= number_format($value->total_bayar, 0,',','.')?></b> <br>
                                    ...
                                    <span class="badge badge-success">Terkonfirmasi</span><br>
...
<?php foreach ($dikirim as $key => $value) { ?>
  <div class="modal fade" id="diterima<?php echo $value->id_transaksi ?>">
