                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php
                                if ($value->level_user == 1 ) {
                                    echo '<span class="badge bg-primary">Operator Dinas</span>';
                                } else {
                                    echo '<span class="badge bg-success">Pedagang</span>';
                                }
                            ?></td>
              ...
              ?>
                ...
                <div class="form-group">
                    ...
                    <select name="level_user" class="form-control">
                        <option value="1" selected>Oprator Dinas</option>
                        <option value="2" selected>Pedagang</option>
                    </select>
                </div>
            </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              ?>
                ...
                <div class="form-group">
                    <label>Nama Lengkap</label>
                    <input type="text" name="nama_lengkap" value="<?= $value->nama_lengkap ?>" class="form-control" placeholder="Nama Lengkap" required>
                </div>
                <div class="form-group">
                    <label>Username</label>
...
<div class="modal fade" id="delete<?= $value->id_user ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete <?= $value->nama_lengkap ?></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
